...
async def server_decorator_application_example():
    ...
    """
    from google_drive.decorators import exception_handler, tool_logger, type_converter
    from google_drive.tools import drive_tools
    from mcp.server.fastmcp import FastMCP

    # Create MCP server
    server = FastMCP("Google Drive")
    config = {}  # Your config dict

    # All tools: Apply decorators in correct order
