...
from google_drive.decorators.sqlite_logger import (
    SQLiteLoggerSink, 
    initialize_sqlite_logging,
    log_tool_execution
)
from google_drive.config import ServerConfig
...
class TestSQLiteLogger:
    ...
    def temp_db_path(self):
        ...
        from google_drive.decorators.sqlite_logger import SQLiteLoggerSink
    ...
    def test_database_initialization(self, temp_db_path):
        ...
        with patch('google_drive.decorators.sqlite_logger.SQLiteLoggerSink._get_database_path') as mock_path:
    ...
    def test_log_tool_execution_function(self, temp_db_path):
        ...
        with patch.object(sink, '_db_path', temp_db_path):
            ...
            with patch('google_drive.decorators.sqlite_logger.logger') as mock_logger:
