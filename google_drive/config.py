"""Configuration management for Google Drive
...
class ServerConfig:
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("google_drive"))
        ...
        self.log_file_path = self.log_dir / "google_drive.log"
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "google_client_secret_path": self.google_client_secret_path,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        if "server" in data:
            ...
            google_drive_config = data.get("google_drive", {})
            return cls(
                name=server_config.get("name", "Google Drive"),
                ...
                google_client_secret_path=google_drive_config.get("client_secret_path", ""),
                max_upload_size_mb=google_drive_config.get("max_upload_size_mb", 500),
            )
        else:
            # Flat structure (legacy or direct from ServerConfig)
            return cls(
                name=data.get("name", "Google Drive"),
                ...
                google_client_secret_path=data.get("google_client_secret_path", ""),
                max_upload_size_mb=data.get("max_upload_size_mb", 500),
            )
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("google_drive")),
        "data_dir": str(platformdirs.user_data_dir("google_drive")),
        "log_dir": str(platformdirs.user_log_dir("google_drive")),
        "cache_dir": str(platformdirs.user_cache_dir("google_drive")),
    }
