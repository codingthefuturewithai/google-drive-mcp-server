"""Home/Dashboard page for Google Drive Admin UI
...
def render_project_overview():
    ...
    with col1:
        ...
        **Project Details:**
        - **Name:** Google Drive
        - **Description:** Google Drive - MCP server with tools and integrations
        - **Author:** Tim Kitchens
...
def render_system_info():
    ...
    with st.expander("🔍 System Information"):
        try:
            from google_drive.ui.lib.utils import get_system_paths
...
def main():
    """Main page content"""
    # Page header
    st.title("🏠 Google Drive Admin Dashboard")
    ...
    # Footer
    st.markdown("---")
    st.caption(f"Google Drive Admin UI • Generated with SAAGA MCP Server Cookie Cutter")
