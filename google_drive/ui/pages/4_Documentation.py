"""Documentation viewer page for Google Drive Admin UI
...
def render_documentation_content():
    ...
    st.markdown("""
    This MCP server was generated from the Google Drive Cookie Cutter template.
    
    **Getting Started:**
    1. Test your server with MCP Inspector: `mcp dev google_drive/server/app.py`
    2. Run the example client: `google_drive-client "Hello World"`
...
def main():
    ...
    # Page header
    st.title("📖 Google Drive Documentation")
