"""Logging configuration for Google Drive MCP server"""
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Google Drive MCP server"""
    ...
    project_logger = logging.getLogger("google_drive")
    ...
    log_file = log_path / "google_drive.log"
